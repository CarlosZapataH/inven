...
function simple_php_captcha($config = array()) {
    ...
    if( !function_exists('gd_info') ) {
        throw new PDOException('Required GD library is missing');
    }
    ...
    $captcha_config = array(
        ...
        'characters' => '1234567890135798642',
        'min_font_size' => 20,
        'max_font_size' => 20,
        'color' => '#666',
        'angle_min' => 0,
...
if( isset($_GET['_CAPTCHA']) ) {
    ...
    if( !file_exists($font) ) throw new PDOException('Font file not found: ' . $font);
