                ...
                if(is_array($arrayInventario) && sizeof($arrayInventario)>0){
                    ...
                    if (file_exists($archivo)) {
                        try {
                            ...
                            $mail->Subject = "Alerta Inventario Resumen - Almacén";
                            $mail->ContentType = "text/plain";
                            //contenido de Mensaje
                            $mail->IsHTML(true);
                            $cuerpo = "Estimados<br>".$saludo."<br><br>Se emite la presente alerta para indicar aquellos items que se encuentran en proceso de alarma en el Almacén:<b>".$almacen['titulo_alm']."</b> <br><br>Saludos<br><br>Soporte IMC";
                            $mail->msgHTML($cuerpo);
