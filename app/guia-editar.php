                ...
                <div v-if="movement">
                    ...
                    <div class="card" id="section_general">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Indicador de los tipos de servicio </label>
                                <div class="col-sm-9">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-md-6 col-xl-8">
                                            <input v-model="generalData.unit_measure" id="dg_at_UnidadMedida" type="text" class="form-control" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
