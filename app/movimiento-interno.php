                    ...
                    <table id="Tbl_Reporte" class="table table-striped table-bordered table-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Atención a</th>
                                <th class="text-center">Nro. Documento(DNI/CE)</th>
                                <th class="text-center">Autorizado</th>
                                <th class="text-center">Almacén Retiro</th>
                                <th class="text-center">Nro.Vale/Guia</th>
...
<script src="../assets/ajax/movimiento_interno.js<?=$version?>"></script>
